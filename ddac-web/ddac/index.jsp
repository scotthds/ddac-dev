                          ...
                          <center>
                            ...
                            <p>
                              ...
                              <p>
                                ...
                                if you see an error message in the Azure like <br>
                                <img src="./quota-failure.png" alt="quotaerr" height="163" width="400"> <br>
                                ...
                                <p>
                                  ...
                                  if you see an error message in the Azure like <br>
                                  <img src="./ext-timeout.png" alt="exterr" height="211" width="400"> <br>
                                  this indicates a possible failure on the Azure Platform or with the ARM templates. You should gather the needed log files and send them to partner-architecture@datastax.com
                                  <p>
                                    on the VM dcvm0 find these files and scp them to your local machine
                                    <ul>
